...
public class ApplicationFormAdapter extends RecyclerView.Adapter<ApplicationFormAdapter.ViewHolder> {
    ...
    private List<ApplicationFormModel> modelList;

    public ApplicationFormAdapter(Context context,Activity activity, List<ApplicationFormModel> applicationFormModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ApplicationFormModel applicationFormModel = modelList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, FormView.class);  // Replace NewActivity with your target Activity
